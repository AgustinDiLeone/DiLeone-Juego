...
class FormMenuPlay(Form):
    def __init__(self, screen, x, y, w, h, color_background,path_image, color_border="Black", active=True):
        ...
        self.btn_level_1 = Button_Image(self._slave,x,y,200,270,50,50,r"RECURSOS\boton_settings.png",self.entrar_nivel,"nivel_uno")
        self.btn_level_2 = Button_Image(self._slave,x,y,200,350,50,50,r"RECURSOS\boton_settings.png",self.entrar_nivel,"nivel_dos")
        self.btn_level_3 = Button_Image(self._slave,x,y,200,420,50,50,r"RECURSOS\boton_settings.png",self.entrar_nivel,"nivel_tres")
        self.btn_home = Button_Image(self._slave,x,y,w-70,h-70,50,50,r"RECURSOS\boton_settings.png",self.btn_home_click,"","","Verdana",15,"Green","red","blue")
