...
class FormPrueba(Form):
    def __init__(self, screen, x, y, w, h, color_background="red", color_border="black", border_size=-1, active=True) -> None:
        ...
        aux_image = pygame.image.load(r"RECURSOS\fondo_form.png")
        ...
        self.boton_tabla = Button_Image(self._slave,x,y,280,500,50,50,r"RECURSOS\boton_settings.png",self.btn_tabla_click,"fghj")
        self.buscar_settings = Label(self._slave,50,405,220,75,"Settings","Comic Sans", 25,"white", "")
        self.boton_settings = Button_Image(self._slave,x,y,280,420,50,50,r"RECURSOS\boton_settings.png",self.btn_settings_click,"fghj")
        self.label_jugar = Label(self._slave,100,580,200,75,"A JUGAR!!","Comic Sans", 25,"white", "")
        self.boton_jugar = Button_Image(self._slave,x,y,300,580,140,75,r"RECURSOS\boton_play.png",self.btn_jugar_click,"a")
    ...
    def btn_jugar_click(self,param):
        frm_jugar = FormMenuPlay(self._master,250,80,700,550,MAGENTA,r"RECURSOS\fondo_sonido.png",WHITE,True)
        self.show_dialog(frm_jugar)

    def btn_settings_click(self,texto):
        form_sonido = FormSonido(self._master,250,80,700,550,"Green","White",True,r"RECURSOS\fondo_sonido.png")
